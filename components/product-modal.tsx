...
const ADDONS: Addon[] = [
  ...
  { id: 'ovo', name: 'Ovo', price: 3.0 },
  { id: 'mussarela', name: 'Mussarela', price: 4.5 },
  { id: 'cheddar', name: 'Cheddar', price: 4.0 },
  { id: 'queijo-extra', name: 'Queijo Extra', price: 3.0 },
  { id: 'alface', name: 'Alface', price: 1.5 },
  { id: 'tomate', name: 'Tomate', price: 1.5 },
  { id: 'picles', name: 'Picles', price: 1.5 },
  { id: 'cebola-caramelizada', name: 'Cebola Caramelizada', price: 3.5 },
  { id: 'molho-especial', name: 'Molho Especial', price: 2.0 },
  { id: 'carne-extra', name: 'Carne Extra', price: 8.0 },
  { id: 'pao-extra', name: 'Pão Brioche Extra', price: 4.0 },
]
  ...
  return (
    <>
      ...
      >
        ...
        {/* Product Image */}
        <div className="relative w-full flex-shrink-0 overflow-hidden rounded-t-2xl bg-muted sm:rounded-t-2xl"
